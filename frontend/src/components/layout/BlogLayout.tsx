            ...
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                <Link to="/" className="flex items-center">
                  ...
                  {/* <span className="ml-2 text-xl font-bold text-gray-900">Laravel Blog</span> */}
                </Link>
              </div>
              ...
              {/* <nav className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <Link to="/blog" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
                  Blog
                </Link>
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-4">
              <div className="relative">
                ...
                {/* <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-md text-sm placeholder-gray-400 focus:outline-none focus:ring-teal-500 focus:border-teal-500"
                /> */}
              </div>
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
              <div className="space-y-8 xl:col-span-1">
                ...
                <p className="text-gray-500 text-base">
                  A comprehensive blog system with advanced RBAC controls and SEO optimization features.
                </p>
            ...
            <div className="mt-12 border-t border-gray-200 pt-8">
              <p className="text-base text-gray-400 text-center">
                &copy; {new Date().getFullYear()} Laravel Blog, Inc. All rights reserved.
              </p>
            </div>
          </div>
        </footer> */}
