...
test('daily metal price repository upserts and returns latest values for each symbol', function () {
    ...
    // use dates well outside any seeded range to avoid collision with seeded data
    $repository->upsert('2000-01-01', 'USD', 'XAU', 2023.12, 'ounce');
    $repository->upsert('2000-01-02', 'USD', 'XAU', 2030.40, 'ounce');
    $repository->upsert('2000-01-02', 'USD', 'XAG', 23.18, 'ounce');
